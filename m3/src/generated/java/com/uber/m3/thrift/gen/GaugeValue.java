...
public class GaugeValue implements org.apache.thrift.TBase<GaugeValue, GaugeValue._Fields>, java.io.Serializable, Cloneable, Comparable<GaugeValue> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GaugeValue");
  ...
  private static final _Fields optionals[] = {_Fields.I64_VALUE,_Fields.D_VALUE};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GaugeValue.class, metaDataMap);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GaugeValue)
      return this.equals((GaugeValue)that);
    return false;
  }

  public boolean equals(GaugeValue that) {
    if (that == null)
      return false;
  ...
  public int hashCode() {
    ...
    boolean present_dValue = true && (isSetDValue());
    list.add(present_dValue);
    if (present_dValue)
      list.add(dValue);
  ...
  @Override
  public int compareTo(GaugeValue other) {
    ...
    lastComparison = Boolean.valueOf(isSetDValue()).compareTo(other.isSetDValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDValue()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dValue, other.dValue);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class GaugeValueStandardSchemeFactory implements SchemeFactory {
    public GaugeValueStandardScheme getScheme() {
      return new GaugeValueStandardScheme();
    }
  }

  private static class GaugeValueStandardScheme extends StandardScheme<GaugeValue> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GaugeValue struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GaugeValue struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GaugeValueTupleSchemeFactory implements SchemeFactory {
    public GaugeValueTupleScheme getScheme() {
      return new GaugeValueTupleScheme();
    }
  }

  private static class GaugeValueTupleScheme extends TupleScheme<GaugeValue> {
