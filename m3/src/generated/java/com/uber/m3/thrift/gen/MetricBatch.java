...
public class MetricBatch implements org.apache.thrift.TBase<MetricBatch, MetricBatch._Fields>, java.io.Serializable, Cloneable, Comparable<MetricBatch> {
  ...
  private static final _Fields optionals[] = {_Fields.COMMON_TAGS};
  ...
  public MetricBatch(MetricBatch other) {
    ...
    if (other.isSetCommonTags()) {
      Set<MetricTag> __this__commonTags = new HashSet<MetricTag>(other.commonTags.size());
  ...
  public int hashCode() {
    ...
    boolean present_commonTags = true && (isSetCommonTags());
    list.add(present_commonTags);
    if (present_commonTags)
      list.add(commonTags);
  ...
  public int compareTo(MetricBatch other) {
    ...
    lastComparison = Boolean.valueOf(isSetCommonTags()).compareTo(other.isSetCommonTags());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCommonTags()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.commonTags, other.commonTags);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem12 = new MetricTag();
                  _elem12.read(iprot);
                  struct.commonTags.add(_elem12);
                }
                iprot.readSetEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          {
            _elem22 = new MetricTag();
            _elem22.read(iprot);
            struct.commonTags.add(_elem22);
          }
        }
        struct.setCommonTagsIsSet(true);
      }
