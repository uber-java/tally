...
public class MetricTag implements org.apache.thrift.TBase<MetricTag, MetricTag._Fields>, java.io.Serializable, Cloneable, Comparable<MetricTag> {
  ...
  private static final _Fields optionals[] = {_Fields.TAG_VALUE};
  ...
  public int hashCode() {
    ...
    boolean present_tagValue = true && (isSetTagValue());
    list.add(present_tagValue);
    if (present_tagValue)
      list.add(tagValue);
