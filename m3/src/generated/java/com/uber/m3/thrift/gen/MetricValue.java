...
public class MetricValue implements org.apache.thrift.TBase<MetricValue, MetricValue._Fields>, java.io.Serializable, Cloneable, Comparable<MetricValue> {
  ...
  private static final _Fields optionals[] = {_Fields.COUNT,_Fields.GAUGE,_Fields.TIMER};
  ...
  public int hashCode() {
    ...
    boolean present_gauge = true && (isSetGauge());
    list.add(present_gauge);
    if (present_gauge)
      list.add(gauge);

    boolean present_timer = true && (isSetTimer());
    list.add(present_timer);
    if (present_timer)
      list.add(timer);
  ...
  public int compareTo(MetricValue other) {
    ...
    lastComparison = Boolean.valueOf(isSetGauge()).compareTo(other.isSetGauge());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGauge()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.gauge, other.gauge);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTimer()).compareTo(other.isSetTimer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimer()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.timer, other.timer);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
